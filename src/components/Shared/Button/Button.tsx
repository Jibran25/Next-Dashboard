...
import LoadingCircle from "@/assets/loader/loading-circle.svg";
  ...
  `,
  {
    variants: {
      ...
      `,
        light: `
          rounded 
          bg-black bg-opacity-60 hover:black active:bg-black disabled:bg-[#E7E8E9]
          text-black hover:text-white disabled:text-white
          border border-transparent
      `,
        outline: `
          rounded border border-black 
          hover:bg-black disabled:bg-black
          text-black hover:text-white disabled:text-white
          hover:border-black disabled:border-black
      `,
        text: `
          gap-2.5 px-0 py-0 
